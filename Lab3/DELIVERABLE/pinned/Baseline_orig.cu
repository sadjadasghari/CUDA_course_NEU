...
__global__ void calculation3(    char* dev_a, 
                                char* dev_b, 
                                char* dev_c,
                                int num_matrices,                                                
                                int matrix_size ) {
...
__global__ void calculation2(char* dev_a,
                                char* dev_b,
                                char* dev_c,
                                int num_matrices,                                          $
                                int matrix_size){ calculation3<<grid_size,block_size>> }
__global__ void calculation(char* dev_a,
                                char* dev_b,
                                char* dev_c,
                                int num_matrices,                                          $
                                int matrix_size){ calculation2<<gird_size,block_size>>}
